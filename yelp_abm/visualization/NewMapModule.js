const MapModule = function (view, zoom, map_width, map_height, tiles, scale_options) {
    ...
    legend.onAdd = function (map) {
        ...
        div.innerHTML += '<i style="background: #0000FF"></i><span>Restaurant</span><br>';
        div.innerHTML += '<i style="background: #069C56"></i><span>Student</span><br>';
        div.innerHTML += '<i style="background: #D3212C"></i><span>Middle-aged</span><br>';
        div.innerHTML += '<i style="background: #FF980E"></i><span>Senior</span><br>';
        return div;
    };
